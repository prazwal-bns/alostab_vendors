...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Vendor All Products</div>
        <div class="ps-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a class="btn btn-success" href="{{route('vendor.add.product')}}">Add Vendor Product</a>
            </div>
        </div>
    </div>
    <!--end breadcrumb-->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if($item->status ==1)
                                    <a href="{{route('vendor.inactive.product', $item->id)}}" class="btn btn-danger" title="Inactive"><i class="fa-solid fa-thumbs-down"></i></a>
                                @else
                                <a href="{{route('vendor.active.product', $item->id)}}" class="btn btn-success" title="Inactive"><i class="fa-solid fa-thumbs-up"></i></a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
