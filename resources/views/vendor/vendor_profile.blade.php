                            ...
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <p class="text-secondary mb-1">{{ $vendorData->phone }}</p>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('vendor.profile.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea class="form-control" id="inputAddress" name="vendor_short_info" placeholder="Vendor Info" rows="3" style="height: 118px;">{{ $vendorData->vendor_short_info }}</textarea>
                                        </div>
                                    </div>
