                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" action="{{ route('update.district', $district->id) }}" method="POST">
                                    @csrf
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <input id="subcategoryTitle" type="text" name="district_name" value="{{ $district->district_name}}" class="form-control" />
                                        </div>
                                    </div>
