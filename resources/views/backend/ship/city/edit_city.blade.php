                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" action="{{ route('update.city', $city->id) }}" method="POST">
                                    @csrf
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            ...
                                            <select name="district_id" class="form-select mb-3" aria-label="Default select example" required>
                                                ...
                                                @foreach ($district as $item)
                                                    <option value="{{ $item->id }}" {{$item->id ==$city->district_id ? 'selected' : ''}}> {{ $item->district_name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <input id="subcategoryTitle" type="text" name="city_name" value="{{ $city->city_name}}" class="form-control" />
                                        </div>
                                    </div>
