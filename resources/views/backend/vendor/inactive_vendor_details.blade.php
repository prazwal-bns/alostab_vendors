                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('active.vendor.approve') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input name="name" type="text" class="form-control" value="{{ $inactiveVendorDetails->name }}" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea class="form-control" id="inputAddress" name="vendor_short_info" placeholder="Vendor Info" rows="3" style="height: 118px;">{{ $inactiveVendorDetails->vendor_short_info }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage" src="{{ !empty($inactiveVendorDetails->photo) ? url('upload/vendor_images/' . $inactiveVendorDetails->photo) : url('upload/no_image.jpg') }}" alt="image" style="width: 100px; height: 100px;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="submit" class="btn btn-success px-3" value="Activate This Vendor" />
                                        </div>
                                    </div>
                            </div>
                            </form>
